    ...
    <div className='w-full h-auto flex justify-center poster2'>
      <div className=' w-full m-2  md:w-1/2 h-auto md:m-6 '>
        ...
        <form onSubmit={(e) => { submit(e) }} className='m-1 md:m-2 flex flex-col justify-center'>
          ...
          <input value={fullName} onChange={(e) => { setFullName(e.target.value) }} className='outline-0 border-slate-600 border-b-[1px] p-1  my-1 md:my-2 mx-2 md:mx-4 text-lg md:text-xl bg-transparent ' type="text" placeholder='Enter your full name' autoComplete="off" />
          <input value={city} onChange={(e) => { setCity(e.target.value) }} className='outline-0 border-slate-600 border-b-[1px] p-1  my-1 md:my-2 mx-2 md:mx-4 text-lg md:text-xl bg-transparent ' type="text" placeholder='Enter your city name' autoComplete="off" />
          <input value={email} onChange={(e) => { setEmail(e.target.value) }} className='outline-0 border-slate-600 border-b-[1px] p-1  my-1 md:my-2 mx-2 md:mx-4 text-lg md:text-xl bg-transparent ' type="text" placeholder='Enter your email' autoComplete="off" />
          <input value={pass} onChange={(e) => { setPass(e.target.value) }} className='outline-0 border-slate-600 border-b-[1px] p-1  my-1 md:my-2 mx-2 md:mx-4 text-lg md:text-xl bg-transparent ' type="password" placeholder='Enter password' autoComplete="off" />
          <input value={pass2} onChange={(e) => { setPass2(e.target.value) }} className='outline-0 border-slate-600 border-b-[1px] p-1  my-1 md:my-2 mx-2 md:mx-4 text-lg md:text-xl bg-transparent ' type="password" placeholder='Confirm password' autoComplete="off" />
